...
<!-- The styles -->
<link id="bs-css"
	href="<c:url value="/resources/css/bootstrap-cerulean.min.css"/>"
	rel="stylesheet">

<link href="<c:url value="/resources/css/charisma-app.css"/>"
	rel="stylesheet">
<link
	href="<c:url value="/resources/bower_components/chosen/chosen.min.css"/>"
	rel='stylesheet'>
<link
	href="<c:url value="/resources/bower_components/responsive-tables/responsive-tables.css"/>"
	rel='stylesheet'>
<link href="<c:url value="/resources/css/jquery.noty.css"/>"
	rel='stylesheet'>
<link href="<c:url value="/resources/css/noty_theme_default.css"/>"
	rel='stylesheet'>
<link href="<c:url value="/resources/css/elfinder.min.css"/>"
	rel='stylesheet'>
<link href="<c:url value="/resources/css/elfinder.theme.css"/>"
	rel='stylesheet'>
<link href="<c:url value="/resources/css/uploadify.css"/>"
	rel='stylesheet'>
...
<!-- calender plugin -->
<script
	src="<c:url value="/resources/bower_components/moment/min/moment.min.js"/>"></script>
<!-- data table plugin -->
<script src="<c:url value="/resources/js/jquery.dataTables.min.js"/>"></script>

<!-- select or dropdown enhancer -->
<script
	src="<c:url value="/resources/bower_components/chosen/chosen.jquery.min.js"/>"></script>
